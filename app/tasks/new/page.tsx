...
export default function NewTaskPage() {
  ...
  async function handleSubmit(e: React.MouseEvent, sendNow: boolean) {
    ...
    // Если "Erstellen & Senden" — сразу отправляем в Telegram
    if (sendNow) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-xl mx-auto px-6 py-10">
        <h1 className="text-2xl font-bold text-gray-900 mb-8">Neuer Auftrag</h1>
        ...
        <form className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex-1 border border-gray-300 hover:bg-gray-50 text-gray-700 text-sm font-medium py-2.5 rounded-lg transition-colors disabled:opacity-50"
            >
